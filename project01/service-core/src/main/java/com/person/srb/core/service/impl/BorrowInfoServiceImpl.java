...
import com.person.common.exception.Assert;
import com.person.common.result.ResponseEnum;
import com.person.srb.core.enums.BorrowInfoStatusEnum;
import com.person.srb.core.enums.BorrowerStatusEnum;
import com.person.srb.core.enums.UserBindEnum;
import com.person.srb.core.mapper.BorrowerMapper;
import com.person.srb.core.mapper.IntegralGradeMapper;
import com.person.srb.core.mapper.UserInfoMapper;
import com.person.srb.core.pojo.entity.BorrowInfo;
import com.person.srb.core.mapper.BorrowInfoMapper;
import com.person.srb.core.pojo.entity.Borrower;
import com.person.srb.core.pojo.entity.IntegralGrade;
...
import com.person.srb.core.service.DictService;
import com.person.srb.core.service.LendService;
...
public class BorrowInfoServiceImpl extends ServiceImpl<BorrowInfoMapper, BorrowInfo> implements BorrowInfoService {
    ...
    public void saveBorrowInfo(BorrowInfo borrowInfo, Long userId) {
        ...
        log.info("用户状态为：" + userInfo.getBorrowAuthStatus().intValue());
        //判断用户信息是否审批通过
        Assert.isTrue(
