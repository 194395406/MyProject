...
import com.person.srb.core.listener.ExcelDictDTOListener;
import com.person.srb.core.pojo.dto.ExcelDictDTO;
import com.person.srb.core.pojo.entity.Dict;
import com.person.srb.core.mapper.DictMapper;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements DictService {
    ...
    public List<Dict> listByParentId(Long parentId) {
        ...
        try {
            ...
            log.error("redis服务器异常1：" + ExceptionUtils.getStackTrace(e));//此处不抛出异常，继续执行后面的代码
        }
        ...
        try {
            ...
            log.error("redis服务器异常2：" + ExceptionUtils.getStackTrace(e));//此处不抛出异常，继续执行后面的代码
        }
        return dictList;
    }
